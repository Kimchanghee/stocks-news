...
export function AdsterraPopunder() {
  const src = normalizeSrc(process.env.NEXT_PUBLIC_ADSTERRA_POPUNDER_SRC)
    || buildSrc(process.env.NEXT_PUBLIC_ADSTERRA_POPUNDER_KEY, process.env.NEXT_PUBLIC_ADSTERRA_POPUNDER_HOST || process.env.NEXT_PUBLIC_ADSTERRA_SCRIPT_HOST);
  if (!src) return null;

  return <Script id="adsterra-popunder" strategy="afterInteractive" src={src} />;
}
